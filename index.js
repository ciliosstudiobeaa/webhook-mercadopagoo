...
app.post("/gerar-pagamento", async (req, res) => {
  try {
    ...
    const body = {
      ...
      back_urls: {
        success: `https://ciliosdabea.netlify.app/?nome=${encodeURIComponent(nome)}&whatsapp=${whatsapp}&servico=${encodeURIComponent(servico)}&diaagendado=${diaagendado}&horaagendada=${horaagendada}`,
