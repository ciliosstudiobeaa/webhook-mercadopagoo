...
// === CONFIGURAÇÃO ===
const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxKtox0VU2EMvKzZdRLCVAr-zSMuGK-8THdqlE9vh3oj4BqQfmgNlNFYV99HGMItN07/exec"; // substitua pelo seu Web App
const ACCESS_TOKEN = process.env.ACCESS_TOKEN; // token Mercado Pago correto
...
app.post("/webhook", async (req, res) => {
  try {
    ...
    const sheetResp = await fetch(GOOGLE_SCRIPT_URL, {
      ...
      body: JSON.stringify({
        paymentId: pagamento.id, // essencial pra planilha aceitar
        nome,
        diaagendado: data,
        horaagendada: hora,
        servico,
